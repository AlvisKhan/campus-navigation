 ...
 * NIT Silchar Campus Guide, Public Services & Emergency Contacts
 */

// 1. Campus Medical & Healthcare Emergency Contacts
export const EMERGENCY_MEDICAL_CONTACTS = [
  {
    id: "ambulance-nits",
    name: "Ambulance NITS",
    numbers: [{ num: "9678780002", display: "+91 96787 80002", primary: true }],
    number: "9678780002",
  ...
  },
  {
    id: "ambulance-2",
    name: "Ambulance 2",
    numbers: [{ num: "9678780007", display: "+91 96787 80007", primary: true }],
    number: "9678780007",
  ...
  },
  {
    ...
    numbers: [{ num: "8610038097", display: "+91 86100 38097", primary: true }],
    number: "8610038097",
  ...
  {
    id: "smch-silchar",
    name: "Silchar Medical College (SMCH)",
    numbers: [{ num: "03842234196", display: "03842-234196", primary: true }],
    number: "03842234196",
    displayNumber: "03842-234196",
    category: "medical",
    categoryLabel: "Medical",
    badge: "Govt Tertiary Hospital",
    description: "Silchar Medical College & Hospital (Ghungoor) — tertiary care, trauma & specialized emergency.",
    icon: "🏥",
    color: "#EC4899",
  },
  {
    id: "ambulance-108",
    name: "Assam Emergency Ambulance",
    numbers: [{ num: "108", display: "108 (Toll Free)", primary: true }],
    number: "108",
    displayNumber: "108",
    category: "medical",
    categoryLabel: "Medical",
...
export const FIRE_AND_RESCUE_CONTACTS = [
  {
    ...
    name: "Fire Emergency",
    designation: "National Fire Service Helpline",
    numbers: [{ num: "101", display: "101 (Toll Free)", primary: true }],
    number: "101",
    displayNumber: "101",
    category: "fire",
    categoryLabel: "Fire & Rescue",
    badge: "Toll Free // 24/7",
    description: "National 24/7 emergency fire rescue and hazard response helpline.",
    icon: "🔥",
    color: "#EA580C",
  },
  {
    id: "silchar-fire-services",
    name: "Silchar Fire & Emergency Services",
    designation: "Silchar Central Fire Station",
    numbers: [{ num: "03842245801", display: "03842-245801", primary: true }],
    number: "03842245801",
    displayNumber: "03842-245801",
    category: "fire",
    categoryLabel: "Fire & Rescue",
    badge: "Silchar Central Station",
    description: "Main Silchar municipal fire brigade & emergency rescue station.",
    icon: "🚒",
    color: "#F97316",
  },
  {
    id: "rangirkhari-fire-services",
    name: "Rangirkhari Fire & Emergency Services",
    designation: "Rangirkhari Fire Outpost",
    numbers: [{ num: "9854212852", display: "+91 98542 12852", primary: true }],
    number: "9854212852",
    displayNumber: "+91 98542 12852",
    category: "fire",
    categoryLabel: "Fire & Rescue",
    badge: "Rangirkhari Station",
    description: "Fire rescue and rapid intervention post located at Rangirkhari.",
    icon: "🚒",
    color: "#FB923C",
  },
];
...
export const DISASTER_MANAGEMENT_CONTACTS = [
  {
    id: "ddma-cachar",
    name: "District Emergency Operation Centre (DDMA)",
    designation: "District Disaster Management Authority",
    numbers: [
      { num: "1077", display: "1077 (Toll Free)", primary: true },
      { num: "03842239249", display: "03842-239249" },
      { num: "9401624141", display: "+91 94016 24141" },
    ],
    number: "1077",
    displayNumber: "1077 / 03842-239249 / 9401624141",
    category: "disaster",
    categoryLabel: "Disaster Management",
    badge: "24/7 Disaster Control",
    description: "Cachar District Emergency Operation Centre (DEOC) & Disaster Management Authority (DDMA).",
    icon: "🌊",
    color: "#0284C7",
  },
  {
    id: "disaster-management-cachar",
    name: "Disaster Management, Cachar",
    designation: "DDMA Control Desk",
    numbers: [{ num: "9401624141", display: "+91 94016 24141", primary: true }],
    number: "9401624141",
    displayNumber: "+91 94016 24141",
    category: "disaster",
    categoryLabel: "Disaster Management",
    badge: "Cachar DDMA Line",
    description: "Direct mobile line for Cachar District Disaster Management & emergency flood/cyclone relief.",
    icon: "🛡️",
    color: "#0D9488",
  },
];
...
export const DISTRICT_ADMIN_CONTACTS = [
  {
    ...
    designation: "District Magistrate & DC Office",
    numbers: [{ num: "03842245056", display: "03842-245056", primary: true }],
    number: "03842245056",
    displayNumber: "03842-245056",
    category: "admin",
    categoryLabel: "District Admin",
    badge: "District Administration",
    description: "Office of the Deputy Commissioner / District Magistrate, Cachar, Silchar.",
    icon: "🏛️",
    color: "#8B5CF6",
  },
  {
...
export const APDCL_POWER_CONTACTS = [
  {
    id: "apdcl-customer-care",
    name: "APDCL Customer Care",
    designation: "24x7 Central Helpline",
  ...
  {
    id: "apdcl-whatsapp",
    name: "APDCL WhatsApp Bot",
    designation: "Instant Chat & Complaints",
  ...
  {
    id: "apdcl-cachar-dgm",
    name: "APDCL Cachar DGM Office",
    designation: "Deputy General Manager, Cachar Circle",
    numbers: [
      { num: "038422420310", display: "03842-2420310", primary: true },
      { num: "8638712347", display: "+91 86387 12347" },
    ],
    number: "038422420310",
  ...
  {
    id: "apdcl-silchar-1",
    name: "APDCL Silchar-I Sub-Division",
    designation: "Electrical Sub-Division 1",
    numbers: [
      { num: "03842241530", display: "03842-241530", primary: true },
      { num: "7577822380", display: "+91 75778 22380" },
    ],
    number: "03842241530",
  ...
  {
    id: "apdcl-silchar-2",
    name: "APDCL Silchar-II Sub-Division",
    designation: "Electrical Sub-Division 2",
    numbers: [
      { num: "03842242120", display: "03842-242120", primary: true },
      { num: "8876243435", display: "+91 88762 43435" },
    ],
    number: "03842242120",
...
export const SENIOR_TIPS = [
  ...
  {
    title: "Save Emergency & Police Contacts Now",
    desc: "Add NITS Ambulance (9678780002), SMCH Hospital (03842-234196), Ghungoor Police Outpost (9678746354), Fire (101), and 108 directly to your speed dial.",
    icon: "🚨",
    badge: "Safety",
  },
  {
